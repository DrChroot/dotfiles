...
function wikiit() { links http://it.wikipedia.org/w/index.php?search="`encode $@`" ;}
function wikies() { links http://es.wikipedia.org/w/index.php?search="`encode $@`" ;}
